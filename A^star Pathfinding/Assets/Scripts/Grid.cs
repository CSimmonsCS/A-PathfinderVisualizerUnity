...
public class Grid<TGridObject>
{
    ...
    public void SetGridObject(Vector3 worldPosition, TGridObject value)//sets value based on location (mouseclick)
    {
        int x, y;
    ...
    public TGridObject GetGridObject(Vector3 worldPosition)//gets value based on location (mouseclick)
    {
        int x, y;
